...
export const movieValidationSchema = z.object({
  ...
  releaseYear: z.string().min(4, { message: "Release year must be after 1000" }),
  plot: z.string().min(10, { message: "Plot must be at least 10 characters long" }),
  producer: z.string().min(3, { message: "Producer name must be at least 3 characters long" }),
});